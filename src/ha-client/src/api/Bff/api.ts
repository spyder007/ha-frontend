...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authGetUserGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserInfo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authGetUserGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthApi.authGetUserGet']?.[localVarOperationServerIndex]?.url;
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authGetUserGet(options?: RawAxiosRequestConfig): AxiosPromise<UserInfo> {
...
export class AuthApi extends BaseAPI {
    ...
    public authGetUserGet(options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authGetUserGet(options).then((request) => request(this.axios, this.basePath));
    }
